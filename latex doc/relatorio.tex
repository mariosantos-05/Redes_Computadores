...
\begin{itemize}
    ...
    \item \textbf{\texttt{peer\_table.py}}: Funciona como a tabela de vizinhos ou estado (\textit{State}). Ele armazena metadados de outros pares registrados na mesma sala (\textit{namespace}) e controla a saúde dos enlaces, marcando pares obsoletos como \texttt{STALE}.
