...
\textbf{Apenas a Biblioteca Padrão do Python (Standard Library)} foi utilizada. Bibliotecas como \texttt{asyncio}, \texttt{socket}, \texttt{json}, \texttt{logging} e \texttt{datetime} estão nativamente embarcadas no Python.
...
$ python3 main.py
\end{lstlisting}
    \item O \textit{CLI} interativo abrirá o canal após notificar seu registro com sucesso. Você pode, agora, explorar os comandos detalhados na Seção 4. 
